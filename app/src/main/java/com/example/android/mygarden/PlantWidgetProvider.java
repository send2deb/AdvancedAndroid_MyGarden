...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    private static RemoteViews getGardenGridRemoteView(Context context) {
        ...
        Intent remoteIntentService = new Intent(context, GridRemoteViewsService.class);
        rv.setRemoteAdapter(R.id.widget_plant_grid, remoteIntentService);
        rv.setEmptyView(R.id.widget_plant_grid, R.id.widget_plant_empty_grid);

        Intent intent = new Intent(context, PlantDetailActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(context, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        rv.setPendingIntentTemplate(R.id.widget_plant_grid,pendingIntent);
        return rv;
    }
}
